...
export type DocId =
  ...
  | 'koap' | 'gk' | 'msk' | 'passport' | 'gaz' | 'pat' | 'meddop' | 'teplo' | 'putl' | 'to170' | 'rezhim' | 'psih' | 'osago' | 'tk' | 'sout' | 'gtn' | 'med29n' | 'gto1013';
...
export const DOCS: { id: DocId; short: string; full: string }[] = [
  ...
  { id: 'to170', short: 'Техосмотр ТС (170-ФЗ)', full: 'Федеральный закон от 01.07.2011 №170-ФЗ «О техническом осмотре транспортных средств и о внесении изменений в отдельные законодательные акты Российской Федерации» — периодичность техосмотра, диагностическая карта, аккредитация операторов' },
  { id: 'rezhim', short: 'Режим труда водителя (приказ №160)', full: 'Приказ Минтранса России от 14.04.2026 №160 «Об установлении особенностей режима рабочего времени и времени отдыха водителей автомобилей» — действует с 01.09.2026 по 01.09.2032, заменил приказ №424 от 16.10.2020' },
  { id: 'psih', short: 'Психиатрическое освидетельствование (приказ №342н)', full: 'Приказ Минздрава России от 20.05.2022 №342н «Об утверждении порядка прохождения обязательного психиатрического освидетельствования работниками, осуществляющими отдельные виды деятельности…» — действует с 01.09.2022, заменил постановление Правительства РФ от 23.09.2002 №695' },
  { id: 'osago', short: 'ОСАГО владельцев ТС (40-ФЗ)', full: 'Федеральный закон от 25.04.2002 №40-ФЗ «Об обязательном страховании гражданской ответственности владельцев транспортных средств» — обязательное страхование автокрана как транспортного средства на дороге, отдельно от страхования ответственности владельца ОПО' },
  { id: 'tk', short: 'ТК РФ — материальная ответственность', full: 'Трудовой кодекс Российской Федерации от 30.12.2001 №197-ФЗ, глава 39 — пределы и случаи полной материальной ответственности работника перед работодателем' },
  { id: 'sout', short: 'СОУТ (426-ФЗ)', full: 'Федеральный закон от 28.12.2013 №426-ФЗ «О специальной оценке условий труда» — периодичность оценки, классы условий труда, аналогичные рабочие места' },
  { id: 'gtn', short: 'Регистрация в Гостехнадзоре (ПП №625)', full: 'Постановление Правительства РФ от 29.05.2026 №625 «Об утверждении Правил государственной регистрации самоходных машин и других видов техники» — действует с 01.09.2026 по 01.09.2032, заменило постановление Правительства РФ от 21.09.2020 №1507; регистрация автокрана как самоходной машины в органах Гостехнадзора' },
  { id: 'med29n', short: 'Периодические медосмотры (приказ №29н)', full: 'Приказ Минздрава России от 28.01.2021 №29н «Об утверждении Порядка проведения обязательных предварительных и периодических медицинских осмотров работников, предусмотренных частью четвёртой статьи 213 Трудового кодекса Российской Федерации...» — действует с 01.04.2021, заменил приказ Минздравсоцразвития России от 12.04.2011 №302н; перечень вредных факторов и работ — по приказу Минтруда России от 31.12.2020 №988н' },
  { id: 'gto1013', short: 'Техосмотр самоходных машин (ПП №1013)', full: 'Постановление Правительства РФ от 13.11.2013 №1013 «О техническом осмотре самоходных машин и других видов техники, зарегистрированных органами, осуществляющими государственный надзор за их техническим состоянием» — периодический техосмотр автокрана как самоходной машины в Гостехнадзоре, отдельно от техосмотра шасси по 170-ФЗ' },
];
...
export const FACETS: Record<string, Facet> = {
  ...
  'rezhim-truda-i-otdyha-voditelya-avtokrana': {
    docs: ['rezhim'], objects: ['personal'], roles: ['kranovshchik', 'zakazchik'],
    norm: 'Приказ Минтранса России №160 от 14.04.2026 — действует с 01.09.2026, заменил приказ №424 от 16.10.2020', terms: ['Режим труда и отдыха водителя', 'Приказ Минтранса №160', 'Специальный перерыв водителя'],
  },
  'psihiatricheskoe-osvidetelstvovanie-kranovshchika': {
    docs: ['psih'], objects: ['personal'], roles: ['kranovshchik', 'zakazchik'],
    norm: 'Приказ Минздрава России №342н от 20.05.2022 — действует с 01.09.2022, не реже раза в 5 лет, заменил постановление Правительства РФ №695 от 23.09.2002', terms: ['Психиатрическое освидетельствование крановщика', 'Приказ Минздрава №342н'],
  },
  'osago-avtokrana': {
  ...
  'materialnaya-otvetstvennost-kranovshchika': {
    docs: ['tk'], objects: ['personal'], roles: ['kranovshchik', 'zakazchik'],
    norm: 'ТК РФ, ст. 241, 242, 243, 244, 248 — пределы и случаи полной материальной ответственности работника', terms: ['Материальная ответственность крановщика', 'Полная материальная ответственность', 'Средний месячный заработок'],
  },
  'sout-kranovshchika-i-stropalshchika': {
    docs: ['sout', 'koap'], objects: ['personal'], roles: ['otv-soderzhanie', 'zakazchik'],
    norm: 'ФЗ №426-ФЗ, ст. 8 ч. 4 — периодичность не реже раза в 5 лет; ст. 14 — классы условий труда', terms: ['Специальная оценка условий труда', 'СОУТ крановщика', 'Аналогичные рабочие места'],
  },
  'registraciya-avtokrana-v-gostehnadzore': {
    docs: ['gtn', 'koap'], objects: ['kran'], roles: ['zakazchik', 'otv-soderzhanie'],
    norm: 'ПП РФ №625 от 29.05.2026 — действует с 01.09.2026, заменило ПП РФ №1507 от 21.09.2020; ст. 19.22 КоАП РФ', terms: ['Регистрация автокрана в Гостехнадзоре', 'Паспорт самоходной машины', 'Гостехнадзор'],
  },
  'periodicheskiy-medosmotr-kranovshchika': {
    docs: ['med29n', 'tk', 'koap'], objects: ['personal'], roles: ['kranovshchik', 'zakazchik'],
    norm: 'Приказ Минздрава России №29н от 28.01.2021 — действует с 01.04.2021, заменил приказ №302н; перечень факторов по приказу Минтруда №988н; ч. 3 ст. 5.27.1 КоАП РФ', terms: ['Периодический медицинский осмотр крановщика', 'Приказ Минздрава №29н', 'Вредные производственные факторы'],
  },
  'tehosmotr-samohodnoy-mashiny-avtokrana': {
    docs: ['gto1013', 'koap'], objects: ['kran'], roles: ['zakazchik', 'otv-soderzhanie'],
    norm: 'Постановление Правительства РФ №1013 от 13.11.2013 (ред. от 17.07.2024) — периодичность раз в год; ст. 9.3 КоАП РФ', terms: ['Технический осмотр самоходной машины', 'Постановление №1013', 'Мосгостехнадзор'],
  },
  'transportnyy-nalog-avtokrana': {
    docs: ['gk'], objects: ['dogovor'], roles: ['zakazchik', 'otv-soderzhanie'],
    norm: 'Глава 28 НК РФ — транспортный налог; закон города Москвы №33 от 09.07.2008 — ставки и порядок уплаты', terms: ['Транспортный налог автокрана', 'Закон города Москвы №33', 'Другие самоходные машины и механизмы'],
  },
};
