...
export type DocId =
  ...
  | 'koap' | 'gk' | 'msk' | 'passport' | 'gaz' | 'pat' | 'meddop' | 'teplo' | 'putl' | 'to170' | 'rezhim' | 'psih' | 'osago' | 'tk' | 'sout' | 'gtn' | 'med29n' | 'gto1013' | 'tyazhkrup';
...
export const DOCS: { id: DocId; short: string; full: string }[] = [
  ...
  { id: 'tyazhkrup', short: 'Спецразрешение на движение тяжеловесного ТС (ПП №2060)', full: 'Постановление Правительства РФ от 01.12.2023 №2060 «Об утверждении Правил движения тяжеловесного и (или) крупногабаритного транспортного средства» — действует с 01.03.2024, заменило приказ Минтранса России от 24.07.2012 №258; порядок выдачи специального разрешения на движение по автомобильным дорогам' },
];
...
export const FACETS: Record<string, Facet> = {
  ...
  'spetsrazreshenie-na-dvizhenie-avtokrana': {
    docs: ['tyazhkrup', 'koap'], objects: ['kran'], roles: ['zakazchik', 'otv-soderzhanie'],
    norm: 'ПП РФ №2060 от 01.12.2023 — действует с 01.03.2024, заменило приказ Минтранса №258 от 24.07.2012; ст. 12.21.1 КоАП РФ', terms: ['Специальное разрешение на движение', 'Тяжеловесное транспортное средство', 'Крупногабаритное транспортное средство'],
  },
  'shemy-stropovki-gruzov': {
    docs: ['fnp461'], objects: ['strop', 'gruz'], roles: ['stropalshchik', 'otv-rabot', 'zakazchik'],
    norm: 'ФНП №461: п. 127 — работа без схем строповки под руководством ответственного; пп. «д» п. 156 — схемы в ППР; п. 157, 158 — выдача ППР и ТК и ознакомление под подпись; п. 217 — функции эксплуатирующей организации, список грузов с массой', terms: ['Схема строповки', 'Список перемещаемых грузов с массой', 'Технологическая карта'],
  },
  'zayavka-na-avtokran': {
    docs: ['fnp461', 'msk'], objects: ['gruz', 'ploshadka', 'dogovor'], roles: ['zakazchik'],
    norm: 'ФНП №461: п. 108, 109, 111 — установка крана стрелового типа; п. 112 — работа ближе 30 м от ЛЭП; пп. «д» п. 217 — список грузов с массой; п. 127 — груз без маркировки массы; пропуск грузового транспорта в Москве — mos.ru', terms: ['Заявка на автокран', 'Вылет стрелы', 'Подбор крана'],
  },
  'stoimost-arendy-avtokrana': {
    docs: ['gk'], objects: ['kran', 'dogovor'], roles: ['zakazchik'],
    norm: 'ГК РФ ст. 632 — аренда ТС с экипажем; ст. 635 — расходы на экипаж несёт арендодатель; формула и ставки калькулятора сайта (ставка × 8 ч × смены, × 1,12 при пропускном режиме)', terms: ['Стоимость аренды автокрана', 'Минимальный заказ', 'Смена крана'],
  },
  'avtokran-25-ili-50-tonn': {
    docs: ['fnp461', 'passport'], objects: ['kran', 'ploshadka'], roles: ['zakazchik'],
    norm: 'ФНП №461: п. 108, 109 — установка крана стрелового типа; паспортные данные КС-55713-1К и КС-65713-1 — грузовой момент, опорный контур, масса', terms: ['Грузовой момент автокрана', 'Опорный контур', 'Класс автокрана'],
  },
  'propusk-avtokrana-v-moskvu': {
    docs: ['msk', 'koap', 'pdd'], objects: ['kran', 'dogovor'], roles: ['zakazchik'],
    norm: 'ПП Москвы от 22.08.2011 №379-ПП — зоны ограничения грузового транспорта, пропуска, РНИС; КоАП РФ ч. 7, 8 ст. 12.16 — штраф 7 500 / 10 000 ₽', terms: ['Пропуск на МКАД', 'РНИС', 'Грузовой пропуск'],
  },
  'zakryvayushchie-dokumenty-arenda-krana': {
    docs: ['putl', 'gk'], objects: ['dogovor'], roles: ['zakazchik'],
    norm: 'Постановление Госкомстата от 28.11.1997 №78 — формы ЭСМ-2, ЭСМ-7; 402-ФЗ ст. 9, ч. 2 и 4 — реквизиты и формы первичных документов; письмо ФНС от 21.10.2013 №ММВ-20-3/96@ — УПД', terms: ['Закрывающие документы', 'Справка ЭСМ-7', 'УПД за аренду крана'],
  },
  'avtokran-16-ili-25-tonn': {
    docs: ['fnp461', 'passport'], objects: ['kran', 'ploshadka'], roles: ['zakazchik'],
    norm: 'ФНП №461: п. 108, 109 — установка крана стрелового типа; паспортные данные КС-35714 и КС-55713-1К — грузовой момент, стрела, шасси, масса', terms: ['Автокран 16 тонн', 'Грузовой момент автокрана', 'Вездеходное шасси'],
  },
  'podyom-gruza-dvumya-kranami': {
    docs: ['fnp461', 'msk'], objects: ['gruz', 'kran', 'ploshadka'], roles: ['otv-rabot', 'zakazchik'],
    norm: 'ФНП №461: п. 127 — подъём груза несколькими ПС только по ППР или ТК, нагрузка не выше грузоподъёмности, под руководством ответственного; п. 155, 156 — ППР; п. 108, 109 — установка', terms: ['Подъём двумя кранами', 'Тандемный подъём', 'Распределение нагрузки'],
  },
  'avtokran-ili-kran-manipulyator': {
    docs: ['fnp461'], objects: ['kran'], roles: ['zakazchik'],
    norm: 'ФНП №461: п. 2 — краны-манипуляторы в области применения; пп. «у» п. 3 — исключение КМУ на фундаменте и до 1 т / 4 т·м; п. 108–112 — установка; п. 147 — учёт', terms: ['Кран-манипулятор', 'КМУ', 'Грузовой момент'],
  },
};
